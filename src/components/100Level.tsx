      ...
      <div className="bg-purple-200 rounded-xl lg:max-w-lg md:max-w-md max-w-sm w-full">
        ...
        <div className="grid gap-6 px-3 py-4">
          {LEVEL_ONE_COURSES.map((course, index) => (
            <div
              key={index}
              className="p-4 border rounded-md bg-purple-50 hovesr:bg-purple-100 transition-all"
            >
...
export default LevelOneCourseList;

export const LevelTwoCourseList = () => {
  return (
    <div className="flex justify-center py-10 px-4">
      <div className="bg-purple-200 rounded-xl lg:max-w-lg md:max-w-md max-w-sm w-full">
        <h1 className="text-4xl rounded-t-xl pl-4 py-4 bg-purple-600 text-white font-bold">
...
export const LevelThreeCourseList = () => {
  return (
    <div className="flex justify-center py-10 px-4">
      <div className="bg-purple-200 rounded-xl lg:max-w-lg md:max-w-md max-w-sm w-full">
        <h1 className="text-4xl rounded-t-xl pl-4 py-4 bg-purple-600 text-white font-bold">
...
export const LevelFourCourseList = () => {
  return (
    <div className="flex justify-center py-10 px-4">
      <div className="bg-purple-200 rounded-xl lg:max-w-lg md:max-w-md max-w-sm w-full">
        <h1 className="text-4xl rounded-t-xl pl-4 py-4 bg-purple-600 text-white font-bold">
...
export const LevelFiveCourseList = () => {
  return (
    <div className="flex justify-center py-10 px-4">
      <div className="bg-purple-200 rounded-xl lg:max-w-lg md:max-w-md max-w-sm w-full">
        <h1 className="text-4xl rounded-t-xl pl-4 py-4 bg-purple-600 text-white font-bold">
