...
const PhoneNavBar = () => {
  ...
  useEffect(() => {
    ...
    // Set initial position of the tubelight
  ...
  return (
    <div>
      <nav className="phone-nav" ref={navRef}>
        <ul>
          {[...Array(5)].map((_, i) => (
            <li key={i}>
              <a
              ...
              >
                <svg>
                  {i === 0 && <use xlinkHref="#home-icon" />}
                  {i === 1 && <use xlinkHref="#favorites-icon" />}
                  {i === 2 && <use xlinkHref="#settings-icon" />}
                  {i === 3 && <use xlinkHref="#plus-icon" />}
                  {i === 4 && <use xlinkHref="#user-icon" />}
                </svg>
              </a>
            </li>
          ))}
        </ul>
        <div className="tubelight" ref={lightRef}>
