    ...
    <div className="flex justify-center py-10">
      <div className="bg-purple-200 rounded-xl lg:max-w-lg md:max-w-md max-w-sm w-full">
        ...
        <div className="flex items-center justify-between text-black rounded-3xl py-2 px-3 bg-white mx-2 mt-3">
          <div className="">
            <h2 className="text-base font-bold">MTS 301</h2>
        ...
        <Link to='/level-three' className=" bg-purple-400 my-5 mx-3 px-3 py-2 rounded-xl inline-block">
          See More
        </Link>
      </div>
    </div>
...
export default LevelThreeLayout;
